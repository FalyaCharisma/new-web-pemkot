...
const cards = [
  ...
  { tag: "Karya Lokal", title: "Ekonomi Kreatif", desc: "Batik Kediren, kerajinan, dan industri kreatif warga.", img: umkm },
      ...
      <div className="container-page mt-8">
        <div className="grid gap-5 md:grid-cols-2 xl:grid-cols-4">
          {cards.map((c) => (
            <article
              key={c.title}
              className="group relative aspect-[3/4] overflow-hidden rounded-3xl border border-border shadow-elegant transition-all duration-500 hover:-translate-y-2 hover:shadow-glow"
            >
              <img
                src={c.img}
                alt={c.title}
              ...
              <div className="absolute inset-x-0 bottom-0 p-7">
                ...
                <h3 className="mt-2 font-serif text-2xl text-white">{c.title}</h3>
