...
export default function AkomodasiIndex({ kategori, subKategori, fasilitas, filters }: Props) {
    ...
    const filteredSubKategori = subKategori.filter((item) => item.kategori_id === selectedKategori);
                          ...
                          <div className="space-y-2">
                              {filteredSubKategori.map((item) => (
                                  ...
                                  >
                                      <input
                                          type="checkbox"
                                          checked={selectedSubKategori.includes(item.id)}
                                          onChange={() => handleSubKategoriChange(item.id)}
                                      />
