                ...
                <form action="{{ route('upload_banner') }}" method="POST" enctype="multipart/form-data" id="form-upload">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <p class="logowarning" style="color:red;"><i>* tipe file berupa .jpg .png .jpeg .webp .svg
                                    dengan size max 8mb </i></p>
                        </div>
                        ...
                        <div class="modal-footer">
                            <button type="submit" class="btn btn-secondary"><i class="fa fa-paper-plane"></i>
                                Simpan</button>
