            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">List Layanan Publik</h4>
                        <div class="d-flex justify-content-end mt-3">
                            <button type="button" class="btn btn-secondary" onclick="location.href='/form-layanan-publik/add'">
...
<script type="text/javascript">
    $(function () {
        var table = $('.table-bordered').DataTable({
            ...
            serverSide: true,
            autoWidth: false,
            ajax: "{{ route('list_layanan_publik') }}",
            columns: [
